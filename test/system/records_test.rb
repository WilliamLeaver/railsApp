...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "should create record" do
    ...
    fill_in "Player 1", with: @record.player_1
    fill_in "Player 1 wins", with: @record.player_1_wins
    fill_in "Player 2", with: @record.player_2
    fill_in "Player 2 wins", with: @record.player_2_wins
